      ...
      >
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50">
          <ul class="space-y-2 font-medium mt-[6rem]">
            ...
            <li>
              <a
                onClick={() => navigate("/admin-contact-main")}
                href="#"
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
            ...
            <li className="ml-[8px] mt-[30px] flex gap-2 dark:text-gray-400 hover:bg-gray-100">
              <a
                ...
                href="#"
                class="flex gap-2 items-center p-2 text-gray-900 rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
            ...
            <li className="ml-[20px]">
              <a
                onClick={() => navigate("/admin-newjoin")}
                href="#"
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
