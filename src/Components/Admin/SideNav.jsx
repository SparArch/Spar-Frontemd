         ...
         <aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 " aria-label="Sidebar">
            <div class="h-full px-6 py-4 overflow-y-auto bg-gray-50">
               <ul class="space-y-6 font-medium mt-[7rem] ">
                  ...
                  <li>
                     <a onClick={() => navigate("/admin-gallery")} href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  ...
                  <li>
                     <a onClick={() => navigate("/admin-downloads")} href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 group">
